...
// To accomplish this translation, we can use our knowledge of loops. Let’s get
// started!
...
// Try other tests like `'Hi, Human'` (to get `IUUA`. or `'a whale of a deal!'` (to
// get `'AAEEOAEEA'`).

var input = 'I need comfortable sleep.';
